package ru.oktemsec.kiparo_clean_code0722.data.storage.sharedprefs
...
class SharedPrefUserStorage(context: Context) : UserStorage {
    ...
    override fun get(): User {
        val firstName = sharedPreferences.getString(KEY_FIRST_NAME, DEFAULT_LAST_NAME) ?: DEFAULT_FIRST_NAME
        val lastName =
